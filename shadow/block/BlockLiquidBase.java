...
{
    public BlockLiquidBase(int par1, Material par2Material)
    {
    ...
    public static double getFlowDirection(IBlockAccess par0IBlockAccess, int par1, int par2, int par3, Material par4Material)
    {
        ...
        if (par4Material == Material.water)
        {
            ...
            var5 = ((BlockLiquidBase)ShadowCraftShadow.liquidShadowMoving).getFlowVector(par0IBlockAccess, par1, par2, par3);
        }
