...
public class ContainerShadowRefinery extends Container{

	protected TileEntityShadowRefinery tileEntity;

	public ContainerShadowRefinery(final InventoryPlayer inventoryPlayer, final TileEntityShadowRefinery te){
		tileEntity = te;
