...
public class ContainerLightRefinery extends Container{

	protected TileEntityLightRefinery tileEntity;

	public ContainerLightRefinery(final InventoryPlayer inventoryPlayer, final TileEntityLightRefinery te){
		tileEntity = te;
