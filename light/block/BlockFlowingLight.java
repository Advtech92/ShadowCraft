...
public class BlockFlowingLight extends BlockLiquidBase{
	/**
	...
	/**
	 * Indicates whether the flow direction is optimal. Each array index
	 * corresponds to one of the four cardinal directions.
	 */
	boolean[] isOptimalFlowDirection = new boolean[4];

	/**
	 * The estimated cost to flow in a given direction from the current point.
	 * Each array index corresponds to one of the four cardinal directions.
	 */
	int[] flowCost = new int[4];

	public BlockFlowingLight(final int par1, final Material par2Material){
	 ...
	 * flow cost.
	 */
	private int calculateFlowCost(final World par1World, final int par2, final int par3, final int par4,
	 ...
	 */
	protected int getSmallestFlowDecay(final World par1World, final int par2, final int par3, final int par4,
		final int par5){
		int var6 = this.getFlowDecay(par1World, par2, par3, par4);
	...
	private boolean liquidCanDisplaceBlock(final World par1World, final int par2, final int par3, final int par4){
		...
		return var5 == this.blockMaterial ? false : (var5 == Material.lava ? false : !this.blockBlocksFlow(par1World,
			par2, par3, par4));
	}
	...
	public int stillLiquidId(){
		return ShadowCraftShadow.liquidShadowMoving.blockID;
	}
